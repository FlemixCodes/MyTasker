...
class db:
    def __init__(self, database: str, host: str = None, username: str = None, password: str = None, myUrl: str = None, isLocal = False) -> None:
        self._myUrl = myUrl
    ...
    def _connect(self, isLocal):
        ...
        elif self._myUrl: connect_url_auto = self._myUrl
